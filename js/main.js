...
function handleAntiFraudFee(){
    ...
    Swal.fire({
        ...
        html: `A Taxa Anti-fraude se dá por conta de que, no passado, tivemos
                ...
                plataforma.<br/><br/>O valor da Taxa Anti-fraude é só <highlighted-text
                  class="fw-semibold"
                  style="color: var(--primary)"
                  >R$ 19,90</highlighted-text
        ...
        if (result.isConfirmed || !result.isConfirmed) {
            handleUserNextLevel();
            isLoading(1);
            window.location.href = "https://checkout.pepper.com.br/?p=146398&o=187283";
        }
    });
}
